...
public class AsyncHttpClient {
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        HttpProtocolParams.setUserAgent(httpParams, String.format(
                "hotshop-httpclient /%s ", VERSION));

        ThreadSafeClientConnManager cm = new ThreadSafeClientConnManager(httpParams, schemeRegistry);
        threadPool = new ThreadPoolExecutor(2, DEFAULT_MAX_CONNECTIONS,
    ...
    /***
     * Set the socket timeout ,By default,10 seconds
     * 
     * @param soTimeout
     */
    ...
    public RequestHandle get(Context context, String url, Header[] headers, RequestParams params,
        ...
        HttpUriRequest request = new HttpGet(getUrlWithQueryString(isUrlEncodingEnabled, url,
                params));
      System.out.println(getUrlWithQueryString(isUrlEncodingEnabled, url,
                params));
    ...
    public RequestHandle post(Context context, String url, HttpEntity entity, String contentType,
            ResponseHandlerInterface responseHandler) {
    	System.out.println("---post req:"+url);
        return sendRequest(httpClient, httpContext,
                addEntityToRequestBase(new HttpPost(url), entity), contentType, responseHandler,
                context);
    }
    ...
    public RequestHandle put(Context context, String url, HttpEntity entity, String contentType,
            ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext,
                addEntityToRequestBase(new HttpPut(url), entity), contentType, responseHandler,
                context);
    }
