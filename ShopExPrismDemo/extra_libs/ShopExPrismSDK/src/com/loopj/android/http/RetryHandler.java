...
class RetryHandler implements HttpRequestRetryHandler {
    ...
    static {
        ...
        // retry-this, since it may happens in some server connection probleam
    ...
    public boolean retryRequest(IOException exception, int executionCount, HttpContext context) {
        Log.d("RetryHandler", "----------------- retry[exception=" + exception.getMessage() + "]  "
                + executionCount);
        boolean retry = true;
        ...
        if (retry) {
            ...
            Log.d("RetryHandler", "----------------- retry.requestType=" + requestType + ",URI="
                    + currentReq.getURI().getPath());
