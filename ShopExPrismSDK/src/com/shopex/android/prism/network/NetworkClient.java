...
public class NetworkClient implements SECURITY, WEBSOCKET {
	...
	public void secret(String token, String clientId, String clientSecret,
		...
		client.get(null, AConstants.REQUEST_API.SECURITY.SECURITY_URL,
				addHeader(token), req, responseHandler);
	}
	...
	public void write(String clientId, String clientSecret, String data,
		...
		client.post(
				null,
				addTail(AConstants.REQUEST_API.SECURITY.WRITE_URL, clientId,
						clientSecret), addHeader(""), req, null,
				responseHandler);
	...
	@Override
	public void checkSession(SessionCheckReq check, String clientId,
			String clientSecret, ShopExAsynchResponseHandler responseHandler) {
		check.setOauth();
		client.get(
				addTail(AConstants.REQUEST_API.SECURITY.CHECKSESSION_URL,
						clientId, clientSecret), check, responseHandler);
	}
